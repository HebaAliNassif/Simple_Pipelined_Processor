...
sim:/processor/CCR_N \
sim:/processor/CCR_Z	\
sim:/processor/executionStageExc/AluExec/Rsrc \
sim:/processor/executionStageExc/AluExec/Rdst \
sim:/processor/executionStageExc/AluExec/result
...
run
run
force -freeze sim:/processor/InPort 16'hFFFFFFFF 0
run
run
run
